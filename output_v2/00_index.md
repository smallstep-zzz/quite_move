...
> 각 분야 파일은 **A~N 14개 섹션**을 포함하며, **N(시장·앱·서비스 생태계 수익성·시장·니즈 검증)**은
> 새 서비스 개발 관점(① 시장 존재 ② 니즈 존재 ③ 수익화 선례)으로 실데이터를 정리한 섹션입니다.
...
> v2 확장 2차: 취미·여가(01~13)에 더해 **매일·매주 반복되는 생활 루틴**(의무의 리듬)을 14~20으로 추가했습니다.
> 루틴 분야는 취미와 달리 '좋아서'가 아니라 '해야 해서' 반복되므로, 마찰의 중심이 **미루기·'다음에' 루프**입니다.

| 파일 | 분야 | 성격 | 대표 페르소나 수 |
|---|---|---|---|
| [14_routine_candidates.md](14_routine_candidates.md) | **일상 루틴 후보 목록** | 루틴 후보 14개 + 추천 6개 선정 근거 | — |
| [15_cleaning.md](15_cleaning.md) | 청소 | **공간 주기(미루기 루프)** | 3 |
| [16_diary.md](16_diary.md) | 일기·저널링 | **기록·연속성(1문장 앵커)** | 3 |
| [17_budgeting.md](17_budgeting.md) | 가계부·지출관리 | **소비·금전(지출 1줄)** | 3 |
| [18_laundry.md](18_laundry.md) | 빨래·세탁 | **위생 주기(분류 카드)** | 3 |
| [19_mealplanning.md](19_mealplanning.md) | 식사준비·장보기 | **의사결정 피로(메뉴 1장)** | 3 |
| [20_digital_cleanup.md](20_digital_cleanup.md) | 디지털 정리·인박스 | **무형자산 팽창(정리 10분)** | 3 |
...
N. 시장·앱·서비스 생태계  시장·니즈·수익성 검증 (새 서비스 개발 관점)
```
